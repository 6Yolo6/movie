...
- [ ] 磁力链接、`.torrent` 种子链接校验符合预期，错误格式会被拒绝
- [ ] 用户可在“我的投稿”查看审核状态并删除自己的投稿
- [ ] 用户可在“我的投稿”编辑自己的资源，编辑后审核状态符合全局“资源审核”开关
- [ ] 影片详情页中自己的投稿排在资源列表前面，并显示编辑按钮
- [ ] 用户可举报失效资源，后台可看到疑似失效状态
- [ ] 举报失效前会出现确认弹窗，取消按钮可正常关闭
- [ ] 管理员审核投稿通过/拒绝后，投稿用户可在“通知”看到结果且未读数更新
- [ ] 管理员修改资源链接状态后，投稿用户可收到链接状态变更通知
- [ ] 用户评论被其他用户回复后，原评论作者可收到站内通知并跳回影片详情
- [ ] 管理员可在用户菜单中选择启用用户快速切换，并可返回管理员账号
- [ ] 用户管理角色下拉不再提供 ADMIN，接口也会拒绝提升为 ADMIN
- [ ] 管理后台功能正常
