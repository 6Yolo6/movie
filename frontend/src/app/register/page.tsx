...
export default function RegisterPage(){
 ...
 return <div className="flex min-h-[80vh] items-center justify-center px-4"><Card title="注册 影窝" className="w-full max-w-md shadow-xl">
  ...
  <Form form={form} onFinish={submit} size="large" layout="vertical">
   ...
   <Form.Item name="email" label="邮箱" extra={policy?.emailVerificationEnabled?"建议优先使用 QQ（@qq.com）或 163（@163.com）邮箱；Gmail 等海外邮箱可能收不到验证码。":undefined} rules={[{required:true,message:"请输入邮箱"},{type:"email",message:"邮箱格式不正确"}]}><Input prefix={<MailOutlined/>} placeholder="优先推荐 QQ / 163 邮箱" autoComplete="email"/></Form.Item>
